...
<form action="/update-product" method="POST" enctype="multipart/form-data">
    ...
    <div>
        ...
        <input type="text" name="title" value="{{ old('title') ? old('title') : $product->title }}" class="form-control" placeholder="Title">
    </div>
    <div>
        <strong>{{ trans('myapp.description') }}</strong>
        <input type="text" name="description" value="{{ old('description') ? old('description') : $product->description }}" class="form-control"
               placeholder="Title">
    </div>
    <div>
